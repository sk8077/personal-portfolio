...
const Nav = () => {
    ...
    const content = <>
        <div className="lg:hidden block absolute top-16 w-full left-0 right-0 bg-slate-900 transition md:hidden " >
    ...
    return (
        <nav id="navbar">
            <div className="bg-slate-900 h-10vh flex justify-between z-50 text-white lg:py-5 px-20 py-4 border-b border-slate-800 ">
                <div className="flex items-center flex-1">
                    <span className="text-3xl font-bold font-serif">$unnyK</span>
                </div>
